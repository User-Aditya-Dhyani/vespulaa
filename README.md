...
Do keep in notice that there are known bugs in bluez that may prevent provisioning due to various errors, but correcting that is beyond our scope (and beyond our capabilities).
